...
from highcharts.defs import MarkerAttributeObject as cls
from highcharts.defs import MarkerASTNode as cls2
from highcharts.defs import MarkerDefinition as cls3
