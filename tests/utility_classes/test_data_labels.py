...
from highcharts_python.utility_classes.data_labels import DataLabel as cls
from highcharts_python.utility_classes.data_labels import NodeDataLabel as cls2
