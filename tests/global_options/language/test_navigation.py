...
from highcharts.global_options.language.navigation import NavigationLanguageOptions as cls
from highcharts.global_options.language.navigation import PopupLanguageOptions as cls2
