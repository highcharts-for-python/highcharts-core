...
from highcharts_python.global_options.language.navigation import NavigationLanguageOptions as cls
from highcharts_python.global_options.language.navigation import PopupLanguageOptions as cls2
