...
from highcharts.global_options.language.accessibility.series import SeriesTypeDescriptions as cls
from highcharts.global_options.language.accessibility.series import SeriesLanguageOptions as cls2
