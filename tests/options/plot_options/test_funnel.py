...
from highcharts_core.options.plot_options.funnel import FunnelOptions as cls
from highcharts_core.options.plot_options.funnel import Funnel3DOptions as cls2
