...
from highcharts_python.options.plot_options.funnel import FunnelOptions as cls
from highcharts_python.options.plot_options.funnel import Funnel3DOptions as cls2
