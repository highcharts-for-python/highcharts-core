...
from highcharts_python.options.plot_options.scatter import ScatterOptions as cls
from highcharts_python.options.plot_options.scatter import Scatter3DOptions as cls2
