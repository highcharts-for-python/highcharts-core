...
from highcharts_core.options.plot_options.gauge import GaugeOptions as cls
from highcharts_core.options.plot_options.gauge import SolidGaugeOptions as cls2
