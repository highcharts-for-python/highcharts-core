...
from highcharts_python.options.plot_options.gauge import GaugeOptions as cls
from highcharts_python.options.plot_options.gauge import SolidGaugeOptions as cls2
