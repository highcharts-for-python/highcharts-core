...
from highcharts_python.options.plot_options.heatmap import HeatmapOptions as cls
from highcharts_python.options.plot_options.heatmap import TilemapOptions as cls2
