    ...
    (
        {
            ...
            "stack_labels": {
                ...
                "defer": False,
                "enabled": True,
                "filter": {"operator": ">=", "property": "some_property", "value": 123},
                "format": "some format",
            ...
            "stops": [[0.0, "#ccc"], [0.1, "#fff"], [0.25, "#999"], [1.0, "#ff0000"]],
    ...
    (
        {
            ...
            "angle": 15,
            "breaks": [
                {"breakSize": 20, "from": 0, "repeat": 1, "to": 100},
                {"breakSize": 50, "from": 100, "repeat": 1, "to": 1000},
            ],
