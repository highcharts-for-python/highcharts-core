...
from highcharts.options.defs import MarkerAttributeObject as cls
from highcharts.options.defs import MarkerASTNode as cls2
from highcharts.options.defs import MarkerDefinition as cls3
