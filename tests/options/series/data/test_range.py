...
from highcharts_python.options.series.data.range import RangeData as cls
from highcharts_python.options.series.data.range import ConnectedRangeData as cls2
