...
from highcharts_python.options.series.dumbbell import DumbbellSeries as cls
from highcharts_python.options.series.dumbbell import LollipopSeries as cls2
