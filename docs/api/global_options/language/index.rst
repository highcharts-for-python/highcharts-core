#################################################################
:mod:`.language <highcharts_core.global_options.language>`
#################################################################
...
.. module:: highcharts_core.global_options.language

******************************************************************************************
class: :class:`Language <highcharts_core.global_options.language.Language>`
******************************************************************************************
