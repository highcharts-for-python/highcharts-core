#################################################################
:mod:`.language <highcharts_python.global_options.language>`
#################################################################
...
.. module:: highcharts_python.global_options.language

******************************************************************************************
class: :class:`Language <highcharts_python.global_options.language.Language>`
******************************************************************************************
