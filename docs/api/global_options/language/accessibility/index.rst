###################################################################################
:mod:`.accessibility <highcharts_python.global_options.language.accessibility>`
###################################################################################
...
.. module:: highcharts_python.global_options.language.accessibility

****************************************************************************************************************************************
class: :class:`AccessibilityLanguageOptions <highcharts_python.global_options.language.accessibility.AccessibilityLanguageOptions>`
****************************************************************************************************************************************
