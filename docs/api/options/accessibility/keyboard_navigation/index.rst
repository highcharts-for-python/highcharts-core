##########################################################################################
:mod:`.keyboard_navigation <highcharts_python.options.accessibility.keyboard_navigation>`
##########################################################################################
...
.. module:: highcharts_python.options.accessibility.keyboard_navigation

*****************************************************************************************************************************************
class: :class:`KeyboardNavigation <highcharts_python.options.accessibility.keyboard_navigation.KeyboardNavigation>`
*****************************************************************************************************************************************
