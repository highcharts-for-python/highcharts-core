...
.. module:: highcharts_python.highcharts

The :mod:`highcharts_python.highcharts` module is designed to be a catch-all module for
...
.. caution::
  ...
  You should be aware that importing the :mod:`highcharts_python.highcharts` module takes
