...
setup(
    ...
    description=('High-end Data Visualization for the Python Ecosystem'),  # Required
    ...
    keywords='highcharts data visualizaiton charts graphing highchartsjs plotting',  # Optional
