...
from highcharts_python.global_options.language.accessibility.announce_new_data import AnnounceNewDataLanguageOptions
from highcharts_python.global_options.language.accessibility.axis import AxisLanguageOptions
from highcharts_python.global_options.language.accessibility.chart_types import ChartTypesLanguageOptions
from highcharts_python.global_options.language.accessibility.exporting import ExportingLanguageOptions
from highcharts_python.global_options.language.accessibility.legend import LegendLanguageOptions
from highcharts_python.global_options.language.accessibility.range_selector import RangeSelectorLanguageOptions
from highcharts_python.global_options.language.accessibility.screen_reader_section import ScreenReaderSectionLanguageOptions
from highcharts_python.global_options.language.accessibility.series import SeriesLanguageOptions, SeriesTypeDescriptions
from highcharts_python.global_options.language.accessibility.sonification import SonificationLanguageOptions
from highcharts_python.global_options.language.accessibility.table import TableLanguageOptions
from highcharts_python.global_options.language.accessibility.zoom import ZoomLanguageOptions
