...
from highcharts_python.options.accessibility.announce_new_data import AnnounceNewData
from highcharts_python.options.accessibility.high_contrast_theme import HighContrastTheme
