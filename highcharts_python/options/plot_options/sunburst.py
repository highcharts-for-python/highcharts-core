...
from highcharts_python.options.plot_options.levels import SunburstLevelOptions, LevelSize
...
from highcharts_python.utility_classes.breadcrumbs import BreadcrumbOptions
