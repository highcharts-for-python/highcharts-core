...
from highcharts_python.utility_classes.events import PointEvents
from highcharts_python.options.series.data.accessibility import DataPointAccessibility
...
class DataBase(HighchartsMeta):
    ...
    def from_array(cls, value):
        ...
        structure as described in the `Highcharts JS <https://www.highcharts.com>`_
        documentation.
