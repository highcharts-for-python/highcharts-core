...
with open(
    os.path.join(os.path.dirname(__file__), "./module_requirements.json"), "r"
) as module_requirements:
    try:
...
INCLUDE_LIBS = [
    ...
    "https://code.highcharts.com/modules/non-cartesian-zoom.js",
...
INCLUDE_STR = """
    ...
    <script src="https://code.highcharts.com/modules/non-cartesian-zoom.js"/>
...
AXIS_TYPES = ["linear", "logarithmic", "datetime", "category"]
...
LANDMARK_VERBOSITY_VALUES = ["all", "one", "disabled"]

DEFAULT_LINKED_DESCRIPTION = (
...
DEFAULT_CHART_PARALLEL_AXES = {
    "line_width": 1,
    "gridlines_width": 0,
    "title": {"text": "", "reserve_space": False},
    "labels": {"x": 0, "y": 0, "align": "center", "reserve_space": False},
    "offset": 0,
}
...
DEFAULT_RESET_ZOOM_BUTTON_THEME = {"zIndex": 6}


## CREDITS DEFAULTS
DEFAULT_CREDITS_HREF = "https://www.highcharts.com?credits"
DEFAULT_CREDITS_STYLE = {"color": "#999999", "cursor": "pointer", "fontSize": "9px"}
...
DEFAULT_BREADCRUMBS_SEPARATOR_STYLE = {"color": "#666666"}
...
DEFAULT_LANG_ACCESSIBILITY_CHART_CONTAINER_LABEL = (
...
DEFAULT_LANG_ACS_X_AXIS_DESCRIPTION_PLURAL = (
    "The chart has {numAxes} X axes displaying {#each(names, -1), }and {names[-1]}."
)
DEFAULT_LANG_ACS_X_AXIS_DESCRIPTION_SINGULAR = (
    "The chart has 1 X axis displaying {names[0]}. {ranges[0]}"
)
DEFAULT_LANG_ACS_Y_AXIS_DESCRIPTION_PLURAL = (
    "The chart has {numAxes} Y axes displaying {#each(names, -1), }and {names[-1]}."
)
DEFAULT_LANG_ACS_Y_AXIS_DESCRIPTION_SINGULAR = (
...
DEFAULT_LANG_ACS_CHART_TYPES_BAR_SINGLE = (
...
DEFAULT_LANG_ACS_CHART_TYPES_BUBBLE_MULTIPLE = (
    "Bubble chart with {numSeries} data series."
)
DEFAULT_LANG_ACS_CHART_TYPES_BUBBLE_SINGLE = (
...
DEFAULT_LANG_ACS_CHART_TYPES_DEFAULT_SINGLE = (
...
DEFAULT_LANG_ACS_CHART_TYPES_SCATTER_SINGLE = (
...
DEFAULT_LANG_ACS_CHART_TYPES_SPLINE_SINGLE = (
    "Line chart with {numPoints} data {#plural(numPoints, points, point)}."
)
DEFAULT_LANG_ACS_CHART_TYPES_UNKNOWN_MAP = (
...
DEFAULT_LANG_ACS_RANGE_SELECTOR_CLICK_BTN_ANNOUNCEMENT = (
...
DEFAULT_LANG_ACS_SRS_ANNOTATION_DESCRIPTION_SINGLE_PT = (
...
ALLOWED_NONE_CONTEXTS = [
    ...
    "ExportingButtons.context_button",
]
