...
from highcharts.options.accessibility.keyboard_navigation.focus_border import FocusBorder
from highcharts.options.accessibility.keyboard_navigation.series_navigation import SeriesNavigation
