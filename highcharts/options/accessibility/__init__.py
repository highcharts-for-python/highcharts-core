...
from highcharts.options.accessibility.announce_new_data import AnnounceNewData
from highcharts.options.accessibility.high_contrast_theme import HighContrastTheme
from highcharts.options.accessibility.keyboard_navigation import KeyboardNavigation
from highcharts.options.accessibility.point import AccessibilityPoint
from highcharts.options.accessibility.screen_reader_section import ScreenReaderSection
from highcharts.options.accessibility.series import AccessibilitySeries
