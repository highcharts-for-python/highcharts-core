...
from highcharts.options.chart.options_3d import Options3D
from highcharts.options.axes.parallel_axes import ParallelAxesOptions
from highcharts.options.chart.reset_zoom_button import ResetZoomButtonOptions
from highcharts.options.chart.scrollable_plot_area import ScrollablePlotArea
