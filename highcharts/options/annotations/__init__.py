...
from highcharts.options.annotations.animation import AnnotationAnimation
from highcharts.options.annotations.control_point_options import AnnotationControlPointOption
from highcharts.options.annotations.events import AnnotationEvent
from highcharts.options.annotations.label_options import LabelOptions
from highcharts.options.annotations.label_options import AnnotationLabel
from highcharts.options.annotations.shape_options import ShapeOptions
from highcharts.options.annotations.shape_options import AnnotationShape
