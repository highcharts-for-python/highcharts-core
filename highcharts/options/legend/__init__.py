...
from highcharts.options.legend.accessibility import LegendAccessibilityOptions
from highcharts.options.legend.navigation import LegendNavigation
from highcharts.options.legend.bubble_legend import BubbleLegend
from highcharts.options.legend.title import LegendTitle
