...
class DumbbellOptions(GenericTypeOptions):
    ...
    def __init__(self, **kwargs):
        ...
        self.connector_width = kwargs.pop('connector_width', 1)
        ...
        self.low_color = kwargs.pop('low_color', '#333333')
    ...
    def _get_kwargs_from_dict(cls, as_dict):
        kwargs = {
            ...
            'connector_width': as_dict.pop('connectorWidth', 1),
            ...
            'low_color': as_dict.pop('lowColor', '#333333'),
