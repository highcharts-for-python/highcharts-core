...
from highcharts.plot_options.heatmap import HeatmapOptions
...
from highcharts.plot_options.polygon import PolygonOptions
from highcharts.plot_options.pyramid import PyramidOptions
from highcharts.plot_options.pyramid import Pyramid3DOptions
from highcharts.plot_options.sankey import SankeyOptions
from highcharts.plot_options.scatter import ScatterOptions
from highcharts.plot_options.scatter import Scatter3DOptions
...
from highcharts.plot_options.bar import WindBarbOptions
...
class PlotOptions(HighchartsMeta):
    ...
    def from_dict(cls, as_dict):
        kwargs = {
            'arcdiagram': as_dict.pop('arcdiagram', None),
            'area': as_dict.pop('area', None),
            'arearange': as_dict.pop('arearange', None),
            'areaspline': as_dict.pop('areaspline', None),
            'bar': as_dict.pop('bar', None),
            'bellcurve': as_dict.pop('bellcurve', None),
            'boxplot': as_dict.pop('boxplot', None),
            'bubble': as_dict.pop('bubble', None),
            'bullet': as_dict.pop('bullet', None),
            'column': as_dict.pop('column', None),
            'columnpyramid': as_dict.pop('columnpyramid', None),
            'columnrange': as_dict.pop('columnrange', None),
            'cylinder': as_dict.pop('cylinder', None),
            'dependencywheel': as_dict.pop('dependencywheel', None),
            'dumbbell': as_dict.pop('dumbbell', None),
            'errorbar': as_dict.pop('errorbar', None),
            'funnel': as_dict.pop('funnel', None),
            'funnel_3d': as_dict.pop('funnel3d', None),
            'gauge': as_dict.pop('gauge', None),
            'heatmap': as_dict.pop('heatmap', None),
            'histogram': as_dict.pop('histogram', None),
            'item': as_dict.pop('item', None),
            'line': as_dict.pop('line', None),
            'lollipop': as_dict.pop('lollipop', None),
            'networkgraph': as_dict.pop('networkgraph', None),
            'organization': as_dict.pop('organization', None),
            'packedbubble': as_dict.pop('packedbubble', None),
            'pareto': as_dict.pop('pareto', None),
            'pie': as_dict.pop('pie', None),
            'polygon': as_dict.pop('polygon', None),
            'pyramid': as_dict.pop('pyramid', None),
            'pyramid_3d': as_dict.pop('pyramid3d', None),
            'sankey': as_dict.pop('sankey', None),
            'scatter': as_dict.pop('scatter', None),
            'scatter_3d': as_dict.pop('scatter3d', None),
            'series': as_dict.pop('series', None),
            'solidgauge': as_dict.pop('solidgauge', None),
            'spline': as_dict.pop('spline', None),
            'steamgraph': as_dict.pop('steamgraph', None),
            'sunburst': as_dict.pop('sunburst', None),
            'tilemap': as_dict.pop('tilemap', None),
            'timeline': as_dict.pop('timeline', None),
            'treemap': as_dict.pop('treemap', None),
            'variablepie': as_dict.pop('variablepie', None),
            'variwide': as_dict.pop('variwide', None),
            'vector': as_dict.pop('vector', None),
            'venn': as_dict.pop('venn', None),
            'waterfall': as_dict.pop('waterfall', None),
            'windbarb': as_dict.pop('windbarb', None),
            'wordcloud': as_dict.pop('wordcloud', None),
            'xrange': as_dict.pop('xrange', None)
        }
    ...
    def _to_untrimmed_dict(self) -> dict:
        untrimmed = {
            ...
            'pyramid_3d': self.pyramid_3d,
            'sankey': self.sankey,
            'scatter': self.scatter,
            'scatter_3d': self.scatter_3d,
            'series': self.series,
            'solidgauge': self.solidgauge,
            'spline': self.spline,
            'steamgraph': self.steamgraph,
